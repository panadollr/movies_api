...
<body >
    ...
    <h2 class="ui center aligned header">Chỉnh sửa blog</h2>
        ...
        <div class="field">
    <label>Tiêu đề</label>
    <input namespace="Tiêu đề" type="text" name="title" value="{{$blog->title}}">
  </div>
  <div class="field">
    <label>Nội dung</label>
    <div id="editor">
        <textarea name="content" id="blog-textarea" cols="30" rows="10">{{ $blog->content }}</textarea>
    </div>
  </div>
  <center><button class="ui fluid black button" type="submit">Cập nhật</button></center>
</form>
    </div>
